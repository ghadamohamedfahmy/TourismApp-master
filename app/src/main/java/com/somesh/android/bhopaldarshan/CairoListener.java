...
public class CairoListener extends RecyclerView.SimpleOnItemTouchListener{
    private static final String TAG = "CairoListener";
    ...
    private final CairoListener.OnReclyclerClickListener mListener;
    private final GestureDetectorCompat mGetGestureDetector;

    public CairoListener(Context context, final RecyclerView recyclerView, CairoListener.OnReclyclerClickListener listener) {
        mListener = listener;
