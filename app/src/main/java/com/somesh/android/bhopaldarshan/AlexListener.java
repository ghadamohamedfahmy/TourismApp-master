...
class AlexListener extends RecyclerView.SimpleOnItemTouchListener {
    private static final String TAG = "AlexListener";
    ...
    private final AlexListener.OnReclyclerClickListener mListener;
    private final GestureDetectorCompat mGetGestureDetector;

    public AlexListener(Context context, final RecyclerView recyclerView, AlexListener.OnReclyclerClickListener listener) {
        mListener = listener;
